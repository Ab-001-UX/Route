...
| Upstash Redis | Latest stable | Rate limiting on API routes and mutations |
| Sentry | Latest stable | Error tracking and crash reporting |
| PostHog | Latest stable | Product analytics |
| Web Speech API | Native | Speech-to-text plate transcription |
...
│   │   ├── trip/
│   │   │   ├── new/
│   │   │   │   └── page.tsx            # Log a trip summary & WhatsApp share
│   │   │   └── page.tsx                # Past trips list
│   │   ├── saved/
...
│   ├── trip/
│   │   └── [id]/
│   │       └── page.tsx                # Public trip summary page for WhatsApp links
