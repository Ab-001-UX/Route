    ...
    <main className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.socialRow}>
          <button type="button" onClick={() => handleOAuth("oauth_apple")} className={styles.socialBtn} aria-label="Sign up with Apple">
          ...
          <button type="button" onClick={() => handleOAuth("oauth_facebook")} className={styles.socialBtn} aria-label="Sign up with Facebook">
          ...
          <button type="button" onClick={() => handleOAuth("oauth_google")} className={styles.socialBtn} aria-label="Sign up with Google">
