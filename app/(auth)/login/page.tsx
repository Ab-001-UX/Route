    ...
    <main className={styles.container}>
      <div className={styles.card}>
        ...
        <div className={styles.socialRow}>
          <button type="button" onClick={() => handleOAuth("oauth_apple")} className={styles.socialBtn} aria-label="Sign in with Apple" disabled={!!oauthLoading}>
          ...
          <button type="button" onClick={() => handleOAuth("oauth_facebook")} className={styles.socialBtn} aria-label="Sign in with Facebook" disabled={!!oauthLoading}>
          ...
          <button type="button" onClick={() => handleOAuth("oauth_google")} className={styles.socialBtn} aria-label="Sign in with Google" disabled={!!oauthLoading}>
